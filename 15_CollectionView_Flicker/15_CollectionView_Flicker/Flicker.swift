...
class Flickr {
    ...
    fileprivate func flickrSearchURLForSearchTerm(_ searchTerm:String) -> URL? {
        ...
        let URLString = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=\(API_KEY.flickerKey.rawValue)&text=\(escapedTerm)&per_page=20&format=json&nojsoncallback=1"
